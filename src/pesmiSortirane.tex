...
\beginsong{Bog ne daj da bi crknu TV}[by={Adi Smolar}]
    ...
    \beginverse % TODO: tota je ista kot prva kitica!!
        \baselineskip=14pt
...
% ==================== 
\beginsong{Bil je konjenik}[by={Taborniška}] %dejanspecialtitle="Bratovščina sinjega galeba 2"
    \beginchorus
...
% ==================== 
\beginsong{Če si srečen}[by={Otroška}]  %dejanspecialtitle="Čas 2"
    \beginchorus
...
% ==================== 
\beginsong{Čuk se je oženil}[by={Otroška}]  %dejanspecialtitle="Čas 3"
    \beginchorus
...
% ==================== 
\beginsong{Dekle moje pojdi z menoj}[by={Vlado Kreslin}]  %dejanspecialtitle="Dan je šel 3"
    \beginchorus
...
% ==================== 
\beginsong{Delam ko zamorc}[by={Jani Kovačič}] %dejanspecialtitle="Dobra mrha 2"
    \beginverse
...
\beginsong{Dont stop me now}[by={Queen}]
    \beginverse
        To\[C]night I’m gonna have my\[Em]self real g\[Am]ood time,
        I feel a\[Dm]live\[G]
        And the \[C]world, I'll \[C7]turn it inside o\[F]ut yeah,
        I'm floating around in e\[A7]cstasy
    ...
    \beginchorus
        \[C]Don’t stop me now,
        I\[Am]’m having such a good t\[F]ime I’m havin\[G]g a ball
        \[C]Don’t stop me now,
        i\[Am]f you wanna have a good\[F] time just giv\[A7]e me a call
        \[Dm]Don’t stop me,
        cause \[Dm]I’m having a good time
        \[Dm]Don’t stop me,
        yes\[Dm]I’m having a good time
        I \[G]don’t wanna stop at all\[F]
    \endchorus

    \beginverse
        I’m a \[C]rocket ship on my way to \[Em]Mars,
        on a col\[Am]lision course
...
\beginsong{Drunken sailor}[by={Škotska ljudska}]
    ...
    \beginverse\baselineskip=14pt
        Put him in the bed with the captain's daughter \rep{3}
        Ear-ly in the morning
    \endverse
...
% ==================== 
\beginsong{En mali slonček}[by={Taborniška}] %dejanspecialtitle="ena pesem2"
    \beginchorus
    ...
    \endchorus
    \beginchorus\baselineskip=14pt
        Dva mala slončka... \rep{100000000000}
    \endchorus
\endsong
...
% ==================== 
\beginsong{Himna MČ}[by={Taborniška}] %dejanspecialtitle="Hajde da ljudojemo 2"
    \beginverse
...
% ==================== 
\beginsong{Hajde da ludojemo}[by={Tajči}]
    \beginverse
...
% ==================== 
\beginsong{Hvala}[by={Rattlesnake}] %dejanspecialtitle="Hey jude"
    \beginverse
...
% ==================== 
\beginsong{Imagine}[by={John Lennon}] %dejanspecialtitle="In the end 3"
    \beginverse
...
% ==================== 
\beginsong{Jutr mam zobarja}[by={Čuki}] %dejanspecialtitle="Jagode in čokolada 2"
    \beginverse
        \[C]Nisem zmatran, pa tud m\[F]ačka nimam
        nimam pl\[C]učnce, pa tu'd kor\[G]one ne
...
% ==================== 
\beginsong{Je v šiški še kaj odprtega}[by={Vlado Kreslin}] %dejanspecialtitle="Just give me a reason 2"
    \beginverse
...
% ==================== 
\beginsong{Ko si na tleh}[by={Pop design}]  %dejanspecialtitle="Ko po 2"
    \beginverse
        \[Am]Včasih nar\[G]obe ti gr\[F]e \[Am]in čudno kr\[G]ižajo s\[F]e poti,
        \[Am]ne najdeš t\[G]ople dlan\[F]i poz\[G]abljen s\[Am]i.
    \endverse

    \beginverse
        \[Am]Prehodiš mn\[G]ogo pušč\[F]av, \[Am]nikjer ne n\[G]ajdeš o\[F]aze, \[G]
        \[C]pa vendar v\[F]eš, da nekj\[G]e spet t\[E]i boš dom\[Am]aaa\[G]aaa...
    \endverse

    \beginchorus
        K\[F]ooo s\[G]i na tl\[C]eeeh \[Am]in ko si s\[F]am,
...
\beginsong{Lemon Tree}[by={Fools Garden}]
    \beginverse\baselineskip=14pt
        ...
        But \[Dm]nothing ever ha\[Em]ppens - and I\[Am] wonder.
    \endverse
...
\beginsong{Lovro}[by={Big foot mama}]
    ...
    \[Em]čakal je nevesto, sov\[G]ražu je bit sm,
    ...
    \beginverse\baselineskip=14pt
        ...
        a sreča ni bla dolga, pismo je prišlo,
...
% ==================== 
\beginsong{Mi ga že spet žingamo}[by={Avseniki}] %dejanspecialtitle="Maček muri 2"
    \beginchorus
...
% ==================== 
\beginsong{Mur mur murenčki}[by={Taborniška}]  %dejanspecialtitle="Mi ga že spet žingamo 2"
    \beginchorus
...
% ==================== 
\beginsong{Miki Milane}[by={Vera Matović}]  %dejanspecialtitle="Moja Liza (žž"
    \beginverse
        \[G]Miki, Mi\[D]lane, b\[C]aš mi ne daš m\[D]ira
        \[G]Ma nije \[D]moje s\[C]rce od pap\[D]ira
        \[G]Pa da ti ga \[D]dam k\[C]ao vizit k\[D]artu
        \[C]Neveran si, \[D]otpadaš u \[G]startu
    \endverse

    \beginverse
        \[G]Što mi kažu da za mene nisi
        \[D]Baš me briga to što đavo ti si
        \[C]Ma dal' si neveran, proveriću ja
        \[D]Da li ženska srca lomiš kao jedan, dva
    \endverse

    \beginverse
        P\[G]robaću te jabuko od zlata
        S\[D]tobom ću da budem iz inata
        M\[C]a dal' si neveran, proveriću ja
        D\[D]a li ženska srca lomiš kao jedan, dva
    \endverse

    \beginchorus
        \[G]Miki, Mi\[D]lane, \[C]baš mi ne daš \[D]mira
        \[G]Ma nije \[D]moje \[C]srce od \[D]papira
        P\[G]a da ti ga d\[D]am k\[C]ao vizit \[D]kartu
        N\[C]everan si, \[D]otpadaš u \[G]startu \rep{2}
    \endchorus
\endsong
...
% ==================== 
\beginsong{Metulj}[by={Šank Rock}]  %dejanspecialtitle="Moja mama je strela 2"
    \beginverse
        \[F]Mrak je,
...
% ==================== 
\beginsong{Nea vem kam}[by={Alo stari!}]  %dejanspecialtitle="Nabiralka zvezd 2"
    \beginverse
...
% ==================== 
\beginsong{Povej mi Marina}[by={Don Jaun}]  %dejanspecialtitle="Photograph 2"
    \beginverse
...
% ==================== 
\beginsong{Prostitutka}[by={Adi Smolar}]  %dejanspecialtitle="Pojdi z menoj v toplice 2"
    \beginverse
...
% ==================== 
\beginsong{Prokleta nedelja}[by={Parni valjak}]
    \beginverse
    ...
    \beginchorus
        Dolazi \[F]duga duga \[G]noć, al i \[C]ona mora \[Am]proć
...
\beginsong{Proklete vijolice}[by={Mi2}]
    ...
    \textnote{\footnotesize A* - X 0 7 6 5 X}
\endsong
...
\beginsong{Sentiš navadni}[by={Zmelkoow}]
    \beginverse
        \[C]Ko si dobra, ko se po\[Gm]skušas upirat in upaš, da t\[Dm]i ne bom verjel, \[Fm]
...
% ==================== 
\beginsong{Someone like you}[by={Adele}]  %dejanspecialtitle="Sentiš navadni 2"
...
% ==================== 
\beginsong{Sladka kot med}[by={Mi2}]  %dejanspecialtitle="Silvesterski poljub 2"
    \beginverse
...
% ==================== 
\beginsong{Country roads}[by={Jonh Denver}] %   %dejanspecialtitle="Siva pot English"

    \beginverse
        \[G] Almost Heaven\[Em]; West Virginia,
        \[D] Blue Ridge Mountains, Sh\[C]enandoah R\[G]iver.
        \[G] Life is old there, \[Em]older than the trees,
        y\[D]ounger than the mountains, Bl\[C]owin' like a br\[G]eeze.
    \endverse
    ...
    \beginverse
        ...
        \[G] Dark and dusty, p\[Em]ainted on the sky,
...
\beginsong{Še je čas}[by={Vlado Kreslin}]
    \beginverse
        ...
        \[F]in nabavil n\[G]ekaj psov, da krajšaj\[C]o mi čas
    \endverse

    \beginverse
        \[C]Zdaj ži\[Em7]vim v tej\[F] hiši\[G]
        \[C]svoji z\[Em7]lati hiš\[F]i,
        \[Em7]Vrata odpiram le še tistim
...
% ==================== 
\beginsong{Tam ob ognju našem}[by={Taborniška}]  %dejanspecialtitle="Taborniška himna 2"
    \beginchorus
...
\beginsong{Ustavil bi čas}[by={California}]
    ...
    \beginchorus
        ...
        če sem res \[B]tisti, ki naj mu bo hudo\[C......D]
    \endchorus
...
% ==================== 
\beginsong{Voda}[by={Dan D}]  %dejanspecialtitle="Ustavil bi čas 2"
    \beginverse
        \[E]Bolečino pijem\[Bm]o
        Skozi dno se vidi sv\[F#m]et
        Lepota je skrita v n\[Am]as
        Vse navidezno je l\[E]až
        Sijaj in beda, drek zlat\[Bm]o
        V žepih ni to kar im\[F#m]aš
        Pripada ti le \[Am]to
        Kar na srečo zaigr\[E]aš.\[Bm].. zai\[F#m]graj\[Am]
    \endverse
...
% ==================== 
\beginsong{Vešč tko k je}[by={Nipke}]   %dejanspecialtitle="Vrži še en pacl gr na ojgn 2"
    \beginverse
...
% ==================== 
\beginsong{Vsak po svoje}[by={Taborniška/Film}]
    \beginverse
...
% ==================== 
\beginsong{V dolini tihi}[by={Lojze Slak}]  %dejanspecialtitle="Vsak po svoje 2"
    \beginverse
...
% ==================== 
\beginsong{Yesterday}[by={Beatles}]  %dejanspecialtitle="YMCA 2"
    \beginverse
...
% ==================== 
\beginsong{Zemlja pleše}[by={Videosex}]  %dejanspecialtitle="Zanzibar 2"
    \beginverse
